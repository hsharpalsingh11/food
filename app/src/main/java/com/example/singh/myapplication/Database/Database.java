package com.example.singh.myapplication.Database;
...
{
    private static final String DB_NAME="Hungry.db";
    ...
    public List<Order> getCarts()
    {
        ...
        String[] sqlSelect = {"ID","ProductId",
                "ProductName","Quantity","Price","Discount","Image"};
